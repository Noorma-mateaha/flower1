        ...
        <header class="main-header">
            ...
            <div class="content-wrapper">
                ...
                <i class="fa fa-arrow-circle-o-left" style="font-size:36px" onClick="history.go(-1);"></i>
                    ...
                    <form action="delivery_update.php?txtid=<?php echo $delivery_id; ?>" method="post" novalidate="novalidate">
                        <div>
                            <p>
                                <label for="delivery_date">วันที่ติดตั้ง</label>
                                <input type="date" id="delivery_date" name="delivery_date" value="<?php echo $row['delivery_date']?>">
                            </p>
                        </div>
                        <label for="status">สถานะ</label>
                            <select type="text" name="status_delivery" class="form-control">
                                <option><?php echo $row['status_delivery']?></option>
                                <option class="bg-success"></option>
                                <option class="bg-danger">จัดส่งแล้ว</option>
                                <option class="bg-danger">ยังไม่ได้จัดส่ง</option>
                            </select><br>
