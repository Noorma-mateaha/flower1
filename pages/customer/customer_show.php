                ...
                <section class="content">
                    ...
                    <div class="box">
                        ...
                        <div class="box-header with-border">
                            <!-- <form action="customer_show.php" method="get" class="form-inline mr-auto">
                                <input class="form-control mr-sm-2" type="text" placeholder="Search" aria-label="Search"
                                    name="search">
                                <button class="btn btn-outline-success btn-rounded btn-sm my-0"
                                    type="submit">Search</button>
                            </form> -->
                            <a href="../sigin/register.php" class="btn btn-info pull-right"><i class="fa fa-plus"></i>
                                เพิ่ม</a>
                            <?php  
                                // $search = isset($_GET['search']) ? $_GET['search'] : '';                
                                $sql = "SELECT * FROM customer 
                                WHERE customer.level = 'M' ";
                            ...
                            <table class="table table-striped">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="customer_form_update.php?txtid=<?php echo $row['customer_id']; ?>"
                                                class="btn btn-success btn-sm">แก้ไข</a>
                                            <a href="customer_del.php?txtid=<?php  echo $row['customer_id'];?> "
