                ...
                <section class="content">
                    ...
                    <div class="box">
                        ...
                        <div class="box-header with-border">
                            ...
                            <div class="box-header with-border">
                                <span align="center">
                                    <h2>รายการสั่งซื้อวัตถุดิบ</h2>
                                </span>
                                <?php
                                 error_reporting( error_reporting() & ~E_NOTICE );
                                    $material_id = $_REQUEST['txtid'];                   
                                    $sql1 = "SELECT * FROM material WHERE material.material_id = '$material_id' ";
                                    $query1 = $conn->query($sql1);                           
                                    $row1=mysqli_fetch_assoc($query1); 
                        
// *****************************************************************************************************************************
                         
                                    $sql2 = "SELECT order_details_material.amount,
                                ...
                                <div class="container">
                                    ...
                                    <?php echo $row1['material_id']; ?> <br>
                                    <label>ชื่อตถุดิบ&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; :</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <?php echo $row1['material_name']; ?><br>
                                    <label>จำนวนคงเหลือ&nbsp;: </label> <?php echo $row1['Import_amount']; ?><br>
                                     <br><br>
                                </div>
