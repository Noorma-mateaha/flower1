                         ...
                         รหัสลูกค้า 
                            <div class="col-sm-12">
                                <input type="text" class="form-control" name="name"
                                    value="<?php   echo $result['user_id']; ?>" require="" placeholder="รหัสลูกค้า" /><br>
                            </div>
                        </div><br>
                        <div class="form-group">
                       ชื่อ
                        ...
                        ที่อยู่
                            <div class="col-sm-12">
                                <input name="address" class="form-control" value="<?php  echo $result['address']; ?>"
                                    require="" placeholder="ที่อยู่" /><br>
                            </div>
                        </div><br>
                        <div class="form-group">
                        บัญชีผู้ใช้
                            <div class="col-sm-12">
                                <input name="address" class="form-control" value="<?php  echo $result['username']; ?>"
                                    require="" placeholder=" บัญชีผู้ใช้" /><br>
                            </div>
                        </div><br><br>
