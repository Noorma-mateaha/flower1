    ...
    ?>
            ...
            <div class="content-wrapper">
                ...
                <i class="fa fa-arrow-circle-o-left" style="font-size:36px" onClick="history.go(-1);"></i>
                    ...
                    <form action="order_product_update.php?txtid=<?php echo $order_product_id; ?>" method="post" novalidate="novalidate">
                        <div>
                            <!-- <p>
                                <label for="date_order">วันที่นัดวัดประตู</label>
                                <input type="date_order" id="date_order" name="date" value="<?php echo $row['date_order']?>">
                            </p> -->
                        </div>
