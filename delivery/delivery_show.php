                    ...
                    <div class="box">
                        <div class="box-header with-border">
                            ...
                            <?php 
                                    ...
                                    INNER JOIN order_product    ON order_product.order_product_id =delivery.order_product_id 
                            ...
                            <table class="table table-striped">
                                ...
                                ?>
                                    <tr>
                                        <th scope="row"><?php echo $row['order_product_id']; ?></th>
                                        <td><?php echo $row['delivery_id']; ?></td>
                                        <td><?php echo $row['delivery_date']; ?></td>
                                        <td><?php echo $row['name']; ?>&nbsp; <?php echo $row['lastname']; ?></td>
                                        <td>
                                            <?php if($row['status_delivery']=="ยังไม่ติดตั้ง"){ ?>
                                            <a href="#" class="btn btn-danger btn-sm"><i class=""></i>ยังไม่ติดตั้ง</a>
                                            <?php }else { ?>
                                            <a class="btn btn-success btn-sm"><i class=""></i>ติดตั้งแล้ว</a>
                                            <?php } ?>
                                        </td>
                                        <td>
                                            ...
                                            <!-- แก้ไข -->
                                            <a href="delivery_del.php?r=delete&id=1" class="btn btn-danger btn-sm"><i class="fa fa-trash-o"></i></a> 
                                        </td>
                                    </tr>
