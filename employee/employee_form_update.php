...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <div class="wrapper">
        ...
        ?>
            <?php 
                include("db.php");
                $employee_id = $_REQUEST['txtid']; ///รับtxtid มาจากemployee_showบรรทัดที่ 116
            ...
            <div class="content-wrapper">
                ...
                <center><h3>แก้ไขข้อมูลพนักงาน </h3></center>
                </section>
                <!-- Main content -->
                ...
                <i class="fa fa-arrow-circle-o-left" style="font-size:36px" onClick="history.go(-1);"></i>
                    ...
                    <div class="box">
                        ...
                        <div class="box-header with-border">
                            <!-- action ส่งผ่านฟอร์ม -->
                            <form action="employee_update.php?txtid=<?php echo $employee_id; ?>" method="post" novalidate="novalidate">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="lastname" class="form-control"
                                        ...
                                        value="<?php  echo $row['employee_lastname']?>">
                                </div>

                                <div class="form-group">
                                    <label for="sex">เพศ</label>
                                    <select class="form-control" name="sex" value="<?php  echo $row['employee_sex']?>"
                                        required="required">
                                        <option>-</option>
                                        <option>ชาย</option>
                                        <option>หญิง</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="tel" class="form-control" placeholder="Enter tel"
                                        required="required" value="<?php  echo $row['employee_tel']?>">
                                </div>
                                <div class="form-group">
                                    <label for="address">ที่อยู่</label>
                                    <input type="text" name="address" class="form-control" placeholder="Enter address"
                                        required="required" value="<?php  echo $row['employee_address']?>">
                                </div>
                                <div class="form-group">
                                    <label for="username">ชื่อผู้ใช้</label>
                                    <input type="username" name="username" class="form-control" placeholder="Enter username"
                                        required="required" value="<?php  echo $row['employee_username']?>">
                                </div>
                                <div class="form-group">
                                    <label for="password">รหัสผ่าน</label>
                                    <input type="password" name="password" class="form-control" placeholder="Password"
                                        required="required" value="<?php  echo $row['employee_password']?>">

                                </div>
                                <div class="form-group">
                                    <label for="level">สถานะ</label>
                                    <input type="level" name="level" class="form-control" placeholder="level"
                                        required="required" value="<?php  echo $row['employee_level']?>">       

                                </div>
                                <button type="submit" name="update" class="btn btn-primary">แก้ไขข้อมูล</button>
                                <button type="submit" name="delete" class="btn btn-danger"><a href="employee_show.php"></a> ยกเลิก </button>
                            </form>
                            </tbody>
                            </table>
                        </div>
